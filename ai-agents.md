...
| Tool | Templates | Docs |
|------|-----------|------|
| Codex CLI | [README](templates/agents/codex/README.md) · [config.toml](templates/agents/codex/config.toml) · [agent-role.toml](templates/agents/codex/agent-role.toml) · [role-agent-template.toml](templates/agents/codex/role-agent-template.toml) · [orchestrator-agent-template.toml](templates/agents/codex/orchestrator-agent-template.toml) · [SKILL.md](templates/agents/codex/SKILL.md) · [AGENTS.md](templates/agents/codex/AGENTS.md) | [GitHub](https://github.com/openai/codex) |
| Claude Code | [README](templates/agents/claude-code/README.md) · [settings.json](templates/agents/claude-code/settings.json) · [settings.json.example](templates/agents/claude-code/settings.json.example) · [settings.local.json](templates/agents/claude-code/settings.local.json) · [.mcp.json](templates/agents/claude-code/.mcp.json) · [.mcp.json.example](templates/agents/claude-code/.mcp.json.example) · [agent.md](templates/agents/claude-code/agent.md) · [role-agent-template.md](templates/agents/claude-code/role-agent-template.md) · [orchestrator-agent-template.md](templates/agents/claude-code/orchestrator-agent-template.md) · [SKILL.md](templates/agents/claude-code/SKILL.md) · [command.md](templates/agents/claude-code/command.md) · [CLAUDE.md](templates/agents/claude-code/CLAUDE.md) · [rule.md](templates/agents/claude-code/rule.md) | [Docs](https://docs.anthropic.com/en/docs/claude-code) |
| Kilo Code | [README](templates/agents/kilo-code/README.md) · [kilo.jsonc](templates/agents/kilo-code/kilo.jsonc) · [agent.md](templates/agents/kilo-code/agent.md) · [role-agent-template.md](templates/agents/kilo-code/role-agent-template.md) · [orchestrator-agent-template.md](templates/agents/kilo-code/orchestrator-agent-template.md) · [SKILL.md](templates/agents/kilo-code/SKILL.md) · [AGENTS.md](templates/agents/kilo-code/AGENTS.md) · [command.md](templates/agents/kilo-code/command.md) | [Docs](https://kilo.ai/docs/customize) |
| OpenCode | [README](templates/agents/opencode/README.md) · [opencode.json](templates/agents/opencode/opencode.json) · [opencode.json.example](templates/agents/opencode/opencode.json.example) · [agent.md](templates/agents/opencode/agent.md) · [role-agent-template.md](templates/agents/opencode/role-agent-template.md) · [orchestrator-agent-template.md](templates/agents/opencode/orchestrator-agent-template.md) · [SKILL.md](templates/agents/opencode/SKILL.md) · [AGENTS.md](templates/agents/opencode/AGENTS.md) | [GitHub](https://github.com/anomalyco/opencode) |
| Amazon Kiro | [README](templates/agents/amazon-kiro/README.md) · [agent.json](templates/agents/amazon-kiro/agent.json.example) · [role-agent-template.json](templates/agents/amazon-kiro/role-agent-template.json) · [orchestrator-agent-template.json](templates/agents/amazon-kiro/orchestrator-agent-template.json) · [mcp.json](templates/agents/amazon-kiro/mcp.json.example) · [REFERENCE.md](templates/agents/amazon-kiro/REFERENCE.md) · [SKILL.md](templates/agents/amazon-kiro/SKILL.md) · [AGENTS.md](templates/agents/amazon-kiro/AGENTS.md) · [steering-*.md](templates/agents/amazon-kiro/steering-always.md) | [Docs](https://kiro.dev/docs) |
...
| **Template** | [config.toml](templates/agents/codex/config.toml) | [settings.json](templates/agents/claude-code/settings.json) · [.example](templates/agents/claude-code/settings.json.example) / [.mcp.json](templates/agents/claude-code/.mcp.json) · [.example](templates/agents/claude-code/.mcp.json.example) | [kilo.jsonc](templates/agents/kilo-code/kilo.jsonc) | [opencode.json](templates/agents/opencode/opencode.json) · [.example](templates/agents/opencode/opencode.json.example) | [agent.json](templates/agents/amazon-kiro/agent.json.example) / [mcp.json](templates/agents/amazon-kiro/mcp.json.example) |
...
|--------|-----------|-------------|-----------|----------|-------------|
| **Template** | [agent-role.toml](templates/agents/codex/agent-role.toml) · [role-agent-template.toml](templates/agents/codex/role-agent-template.toml) · [orchestrator-agent-template.toml](templates/agents/codex/orchestrator-agent-template.toml) | [agent.md](templates/agents/claude-code/agent.md) · [role-agent-template.md](templates/agents/claude-code/role-agent-template.md) · [orchestrator-agent-template.md](templates/agents/claude-code/orchestrator-agent-template.md) | [agent.md](templates/agents/kilo-code/agent.md) · [role-agent-template.md](templates/agents/kilo-code/role-agent-template.md) · [orchestrator-agent-template.md](templates/agents/kilo-code/orchestrator-agent-template.md) | [agent.md](templates/agents/opencode/agent.md) · [role-agent-template.md](templates/agents/opencode/role-agent-template.md) · [orchestrator-agent-template.md](templates/agents/opencode/orchestrator-agent-template.md) | [agent.json](templates/agents/amazon-kiro/agent.json.example) · [role-agent-template.json](templates/agents/amazon-kiro/role-agent-template.json) · [orchestrator-agent-template.json](templates/agents/amazon-kiro/orchestrator-agent-template.json) |
