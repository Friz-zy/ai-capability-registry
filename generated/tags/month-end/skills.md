...
- **Path**: `external/anthropic-knowledge-work-plugins/finance/skills/close-management`
- **Skill file**: `external/anthropic-knowledge-work-plugins/finance/skills/close-management/SKILL.md`
- **Tags**: `activities`, `blockers`, `calendar`, `close`, `close-management`, `day`, `dependencies`, `end`, `finance`, `identifying`, `manage`, `management`, `month`, `month-end`, `planning`, `process`, `progress`, `sequencing`, `status`, `tracking`
