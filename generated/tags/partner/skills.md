...
- **Source**: `anthropic-knowledge-work-plugins` (trusted)
- **Path**: `external/anthropic-knowledge-work-plugins/partner-built/zoom-plugin/skills/virtual-agent`
- **Skill file**: `external/anthropic-knowledge-work-plugins/partner-built/zoom-plugin/skills/virtual-agent/SKILL.md`
- **Tags**: `android`, `base`, `build`, `build-zoom-virtual`, `embeds`, `handling`, `implementing`, `integrations`, `ios`, `knowledge`, `knowledge-base`, `lifecycle`, `partner`, `routing`, `sync`, `troubleshooting`, `virtual`, `web`, `wrapper`, `zoom`
...
- **Source**: `anthropic-knowledge-work-plugins` (trusted)
- **Path**: `external/anthropic-knowledge-work-plugins/partner-built/zoom-plugin/skills/webhooks`
- **Skill file**: `external/anthropic-knowledge-work-plugins/partner-built/zoom-plugin/skills/webhooks/SKILL.md`
- **Tags**: `delivery`, `driven`, `event`, `event-driven`, `handling`, `implementing`, `partner`, `retries`, `routing`, `selection`, `signature`, `subscriptions`, `verification`, `webhooks`, `zoom`, `zoom-webhooks`
...
- **Source**: `anthropic-knowledge-work-plugins` (trusted)
- **Path**: `external/anthropic-knowledge-work-plugins/partner-built/zoom-plugin/skills/rtms`
- **Skill file**: `external/anthropic-knowledge-work-plugins/partner-built/zoom-plugin/skills/rtms/SKILL.md`
- **Tags**: `audio`, `center`, `chat`, `contact`, `contact-center`, `live`, `live-media`, `media`, `partner`, `processing`, `real`, `real-time`, `routing`, `rtms`, `screen`, `share`, `streams`, `time`, `transcripts`, `video`, `voice`, `zoom`, `zoom-rtms`
