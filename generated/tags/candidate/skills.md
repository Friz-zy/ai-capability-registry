...
- **Path**: `external/anthropic-knowledge-work-plugins/human-resources/skills/draft-offer`
- **Skill file**: `external/anthropic-knowledge-work-plugins/human-resources/skills/draft-offer/SKILL.md`
- **Tags**: `assembling`, `base`, `bonus`, `candidate`, `comp`, `draft`, `draft-offer`, `equity`, `guidance`, `hiring`, `human`, `itself`, `letter`, `manager`, `negotiation`, `offer`, `package`, `prepping`, `ready`, `signing`, `terms`, `text`, `total`
...
- **Path**: `external/trailofbits-skills/plugins/culture-index/skills/interpreting-culture-index`
- **Skill file**: `external/trailofbits-skills/plugins/culture-index/skills/interpreting-culture-index/SKILL.md`
- **Tags**: `accepts`, `analysis`, `assessment`, `behavioral`, `brake`, `burnout`, `candidate`, `coaching`, `comparison`, `composition`, `conflict`, `culture`, `data`, `debrief`, `detection`, `extracted`, `extraction`, `gas`, `glue`, `hiring`, `individual`, `input`, `interpretation`, `interpreting`, `interpreting-culture`, `interprets`, `interview`, `manager`, `mediation`, `onboarding`, `opencv`, `pdf`, `personality`, `planning`, `prediction`, `profile`, `profiles`, `script`, `supports`, `surveys`, `team`, `trait`, `transcript`
