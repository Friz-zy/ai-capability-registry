# Support Customers or Sales

Research accounts, prepare customer interactions, triage support, and manage outreach.
...
- **attio**: 1 server(s) — `mcp/catalog/keywords/attio/servers.md`
...
- **hubspot**: 1 server(s) — `mcp/catalog/keywords/hubspot/servers.md`
