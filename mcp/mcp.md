...
- **Software Engineer**: `mcp/catalog/roles/software-engineer/servers.md` -> `analysis`, `astro`, `automation`, `bindings`, `communication`, `context7`, `development`, `documentation`, `error-analysis`, `incident`, `management`, `oauth`
- **Backend Engineer**: `mcp/catalog/roles/backend-engineer/servers.md` -> `actions`, `aks`, `amazon`, `amazon-neptune`, `analytics`, `authentication`, `aws`, `aws-knowledge`, `awslabs`, `azure`, `bigquery`, `cloudflare`
- **Frontend Engineer**: `mcp/catalog/roles/frontend-engineer/servers.md` -> `actions`, `astro`, `canva`, `code-examples`, `context7`, `design`, `developer-portal`, `development`, `git`, `github`, `issues`, `javadocs`
- **Mobile and Desktop Engineer**: `mcp/catalog/roles/mobile-engineer/servers.md` -> `actions`, `astro`, `code-examples`, `context7`, `developer-portal`, `development`, `git`, `github`, `issues`, `javadocs`, `library-documentation`, `linear`
- **QA Engineer**: `mcp/catalog/roles/qa-engineer/servers.md` -> `actions`, `analysis`, `astro`, `automation`, `code-examples`, `communication`, `context7`, `developer-portal`, `development`, `documentation`, `git`, `github`
...
- **Blockchain Engineer**: `mcp/catalog/roles/blockchain-engineer/servers.md` -> `analysis`, `authentication`, `bindings`, `blockchain`, `cairo`, `context7`, `contracts`, `crypto`, `development`, `error-analysis`, `incident`, `malware`
...
- **Plan a Feature or Spec**: `mcp/catalog/tasks/plan-feature/servers.md` -> `analysis`, `automation`, `bindings`, `canva`, `communication`, `competitive-intelligence`, `context7`, `design`, `development`, `documentation`, `error-analysis`, `feature-flags`
- **Implement or Refactor Code**: `mcp/catalog/tasks/implement-code/servers.md` -> `analysis`, `astro`, `bindings`, `context7`, `development`, `documentation`, `error-analysis`, `incident`, `oauth`, `scorecard`, `scorecard-mcp`, `semgrep`
- **Review Code or PR**: `mcp/catalog/tasks/review-code/servers.md` -> `analysis`, `authentication`, `bindings`, `context7`, `development`, `error-analysis`, `incident`, `malware`, `malware-patrol`, `malwarepatrol`, `oauth`, `scorecard`
...
- **Security Audit or Threat Model**: `mcp/catalog/tasks/security-audit/servers.md` -> `analysis`, `authentication`, `bindings`, `context7`, `development`, `error-analysis`, `incident`, `malware`, `malware-patrol`, `malwarepatrol`, `oauth`, `security`
- **Build Frontend or UI**: `mcp/catalog/tasks/build-frontend/servers.md` -> `astro`, `canva`, `context7`, `design`, `scorecard`, `scorecard-mcp`, `validation`, `web`, `web-scraping`, `webzum`
- **Build Backend or Integration**: `mcp/catalog/tasks/build-backend/servers.md` -> `actions`, `alfresco`, `anurag`, `anuragd`, `awesome`, `bgpt`, `big`, `cloudflare`, `code-examples`, `composio`, `context-awesome`, `context7`
...
- **Build Blockchain or Smart Contracts**: `mcp/catalog/tasks/build-blockchain/servers.md` -> `analysis`, `authentication`, `bindings`, `blockchain`, `cairo`, `context7`, `contracts`, `crypto`, `development`, `error-analysis`, `incident`, `malware`
...
- **Build Mobile or Desktop App**: `mcp/catalog/tasks/build-mobile-desktop/servers.md` -> `astro`, `context7`, `scorecard`, `scorecard-mcp`, `validation`, `web`, `web-scraping`, `webzum`
