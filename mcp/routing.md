...
- **Founder Business Owner** (`founder-business-owner`) -> `airlines`, `asana`, `asset-management`, `audit`, `aws-location`, `aws-pricing`, `awslabs-billing-cost`, `awslabs-cost-explorer`, `billing`, `carbon`, `competitive-intelligence`, `compliance`
...
- **Product Marketing Manager** (`product-marketing-manager`) -> `apollo`, `attio`, `cms`, `competitive-intelligence`, `content`, `crm`, `customer-support`, `feature-flags`, `hubspot`, `insights`, `intercom`, `marketing`
- **Sales Strategist** (`sales-strategist`) -> `amazon-kendra-index`, `apollo`, `attio`, `aws-knowledge`, `cms`, `code-examples`, `competitive-intelligence`, `content`, `context7`, `crm`, `deepwiki`, `directory`
- **Solution Consultant** (`solution-consultant`) -> `analysis`, `apollo`, `appsync`, `architecture`, `attio`, `aws-appsync`, `bindings`, `competitive-intelligence`, `context7`, `crm`, `debug`, `development`
...
- **Database Engineer** (`database-engineer`) -> `aks`, `amazon`, `amazon-neptune`, `analysis`, `analytics`, `appsync`, `architecture`, `aws`, `aws-appsync`, `aws-bedrock`, `aws-cdk`, `aws-core`
- **Cloud Architect** (`cloud-architect`) -> `aks`, `amazon`, `appsignals`, `audit`, `authentication`, `aws`, `aws-appsync`, `aws-bedrock`, `aws-cdk`, `aws-core`, `aws-dataprocessing`, `aws-diagram`
- **SRE** (`sre`) -> `aks`, `amazon`, `amazon-neptune`, `analytics`, `appsignals`, `audit`, `authentication`, `aws`, `aws-appsync`, `aws-bedrock`, `aws-cdk`, `aws-core`
- **Incident Commander** (`incident-commander`) -> `airlines`, `aks`, `amazon`, `appsignals`, `asana`, `asset-management`, `aws`, `aws-appsync`, `aws-bedrock`, `aws-cdk`, `aws-core`, `aws-dataprocessing`
...
- **Procurement Manager** (`procurement-manager`) -> `airlines`, `amazon-kendra-index`, `asana`, `asset-management`, `audit`, `aws-knowledge`, `aws-location`, `aws-pricing`, `awslabs-billing-cost`, `awslabs-cost-explorer`, `billing`, `carbon`
- **Technical Writer** (`technical-writer`) -> `amazon-kendra-index`, `aws-knowledge`, `code-examples`, `competitive-intelligence`, `content`, `context7`, `customer-support`, `deepwiki`, `directory`, `discovery`, `document`, `documentation`
- **Knowledge Manager** (`knowledge-manager`) -> `airlines`, `amazon-kendra-index`, `asana`, `asset-management`, `aws-knowledge`, `aws-location`, `carbon`, `code-examples`, `content`, `context7`, `customer-support`, `deepwiki`
- **Content Marketer** (`content-marketer`) -> `amazon-kendra-index`, `aws-knowledge`, `cms`, `code-examples`, `competitive-intelligence`, `content`, `context7`, `deepwiki`, `directory`, `discovery`, `document`, `documentation`
- **Recruiter** (`recruiter`) -> `airlines`, `asana`, `asset-management`, `aws-location`, `carbon`, `e-commerce`, `googleapis-mapstools`, `health`, `indeed`, `location`, `management`, `maps`
