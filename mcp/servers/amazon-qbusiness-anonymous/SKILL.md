---
name: "amazon-qbusiness-anonymous-mcp"
...
- Launch through Docker stdio with `docker run --rm -i -e AWS_SECRET_ACCESS_KEY -e AWS_SESSION_TOKEN mcp/amazon-qbusiness-anonymous-mcp-server`.
