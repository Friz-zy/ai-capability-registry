---
name: "creative-media-producer-middle"
description: "middle Creative Media Producer. Create and refine media assets with clear constraints, rights awareness, and output-quality checks."
...
## Output Format
```yaml
role: creative-media-producer-middle
